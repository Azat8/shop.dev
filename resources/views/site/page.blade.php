            ...
            <div class="row">
                <div class="col-md-9 single_left">
                    ...
                    <div class="single_right">
                        ...
                        <h3>Lorem ipsu</h3>
                        <p class="m_10">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                        ...
                        <ul class="add-to-links">
                            <li><img src="{{asset('assets')}}/images/wish.png" alt=""><a href="#">Add to wishlist</a>
                            </li>
                        </ul>
